                    ...
                    render={({ field }) => {
                      ...
                      return (
                        <FormItem>
                          ...
                          <FormDescription>
                            Detta fylls i automatiskt med test-OTP:n.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      );
          ...
          <Form {...signupForm}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Detta är en slumpmässigt genererad e-postadress
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="w-full">Lösenord</FormLabel>
                    <FormControl>
                      <Input type="password" placeholder="*****" {...field} />
                    </FormControl>
                    <FormDescription>
                      Detta är ett slumpmässigt genererat lösenord
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
